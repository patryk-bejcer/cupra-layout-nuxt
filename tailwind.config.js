...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'h1': ['3.75rem', { lineHeight: '1', fontWeight: '100', letterSpacing: '2px' }], // h1: 60px 300 weight
        'h2': ['2.5rem', { lineHeight: '1', fontWeight: '100', letterSpacing: '2px' }],   // h2: 40px 300 weight
        'h3': ['2.25rem', { lineHeight: '1.25', fontWeight: '100', letterSpacing: '2px' }],  // h3: 36px 300 weight
